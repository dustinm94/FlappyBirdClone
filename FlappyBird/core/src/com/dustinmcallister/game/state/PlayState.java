...
import com.dustinmcallister.game.sprites.Bird;
import com.dustinmcallister.game.sprites.Tube;
...
public class PlayState extends State {
    ...
    public void update(float dt) {
        ...
        for(int i = 0; i < tubes.size; i++) {
            ...
            if(tube.collides(bird.getBounds()))
                gsm.set(new PlayState(gsm));  // WARNING. Do not use on larger scale projects. Will affect PERFORMANCE.
        }
    ...
    public void dispose() {
        ...
        System.out.println("Play State Disposal.");
